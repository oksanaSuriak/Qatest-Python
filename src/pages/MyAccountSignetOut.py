from QAtest.src.pages.locators.MyAccountSignetOutLocator import MyAccountSignetOutLocator
from QAtest.src.SeleniumExtended import SeleniumExtended
from QAtest.src.helper.config_helpers import get_base_url
import logging as logger

class MyAccountSignetOut(MyAccountSignetOutLocator):
     ...
     def wait_until_error_is_displayed(self, exp_err):
         self.sl.wait_untill_element_contains_text(self.ERRORS_UL, exp_err)
