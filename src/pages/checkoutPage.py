...
from QAtest.src.pages.locators.CheckoutLocator import CheckoutLocator
from QAtest.src.helper.generic_helpers import generate_random_email_and_password
...
class CheckoutPage(CheckoutLocator):
    ...
    def input_billing_streer_address(self, address1=None):
    ...
    def input_billing_email(self, email=None):
        if not email:
            ...
            self.sl.wait_and_input_text(self.BILLING_EMAIL_1_FIELD, email)
    def fill_in_billing_info(self, f_name=None, l_name=None, street1=None, city=None, zip_code=None, phone=None, email=None):
        ...
        self.input_billing_streer_address(address1=street1)
